...
result_names = ['exp_crop_coco_origin_clean_long_250k']
model_weights_list = ['/home/siyu/ssd-dev/originclean-ssd/models/VGGNet/ssd_coco_origin_clean_long/VGG_ssd_coco_origin_clean_long_iter_250000.caffemodel']
...
for idx, result_name in enumerate(result_names):
    ...
    model_def = '/home/siyu/ssd-dev/originclean-ssd/jobs/VGGNet/ssd_coco_origin_clean_long/deploy.prototxt'
