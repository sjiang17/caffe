...
if not len(sys.argv) == 3:
    print "parameter number should be 2!"
    sys.exit()
...
model_def = '/home/siyu/ssd-dev/part-ssd/jobs/VGGNet/{}/deploy.prototxt'.format(job_name)
model_weights = '/home/siyu/ssd-dev/part-ssd/models/VGGNet/{}/VGG_{}_iter_{}.caffemodel'.format(job_name, job_name, iteration)
...
result_root_path = '/home/siyu/detection_results/coco/{}_{}'.format(job_name, iteration)
