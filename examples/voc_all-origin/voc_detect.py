...
model_def = '/home/siyu/ssd-dev/origin-ssd/jobs/VGGNet/voc_all_origin/deploy.prototxt'
model_weights = '/home/siyu/ssd-dev/origin-ssd/models/VGGNet/voc_all_origin/VGG_voc_all_origin_iter_120000.caffemodel'
result_name = 'voc_all_origin_120k_CROP'
...
data_root_path = '/home/siyu/dataset/voc_all/val/Crop_JPEGImages'
...
for img_ind, image_path in enumerate(image_list):
    ...
    for i in xrange(top_conf.shape[0]):
        ...
        cur_box = [score_res, x_res, y_res, xmax_res, ymax_res, json_img_id]
        ...
        json_per_result = [{"image_id": json_img_id, "category_id": cat_ind, \
                            "bbox": json_bbox, "score": score_res}]
