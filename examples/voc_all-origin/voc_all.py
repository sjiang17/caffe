...
train_data = "/home/siyu/dataset/voc_all/lmdb/voc_all_train_lmdb"
# The database file for testing data. Created by data/coco/create_data.sh
test_data = "/home/siyu/dataset/voc_all/lmdb/voc_all_val_lmdb"
...
job_name = "{}".format('voc_all_originml')
...
# output_result_dir = "/data/siyu/data/mscoco/results/{}".format(job_name)
output_result_dir = ""
...
mbox_layers = CreateMultiBoxHead_Clean(net, data_layer='data', from_layers=mbox_source_layers,
...
mbox_layers.insert(-1, net.label)
...
net["mbox_clean_sigmoid"] = L.Sigmoid(net["mbox_clean"])
mbox_layers[3] = net["mbox_clean_sigmoid"]
